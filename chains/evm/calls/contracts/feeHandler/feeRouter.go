...
// AdminSetResourceHandler sets provided FeeHandler as handler for provided domainID and resourceID. https://github.com/ChainSafe/sygma-solidity/blob/master/contracts/handlers/FeeHandlerRouter.sol#L54
